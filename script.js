...
// Objetivo: Versão estável com URLs de textura e áudio corrigidas para evitar erros 404 e 403.
...
// --- TEXTURAS (LINKS CORRIGIDOS) ---
const texturaTerraDia = textureLoader.load('terra.png');
const texturaTerraNoite = textureLoader.load('terra.png');
const texturaTerraNuvens = textureLoader.load('https://raw.githubusercontent.com/barbarossace/threejs-planets/main/assets/earth_clouds.png');
const texturasPlanetasRochosos = [
    'https://raw.githubusercontent.com/barbarossace/threejs-planets/main/assets/mars.jpg',
    'https://raw.githubusercontent.com/barbarossace/threejs-planets/main/assets/venus.jpg'
];
const texturasGigantesGasosos = [
    'https://raw.githubusercontent.com/barbarossace/threejs-planets/main/assets/jupiter.jpg',
    'https://raw.githubusercontent.com/barbarossace/threejs-planets/main/assets/uranus.jpg'
];
const texturaRochaLua = textureLoader.load('https://raw.githubusercontent.com/barbarossace/threejs-planets/main/assets/moon.jpg');
const texturaAneis = textureLoader.load('https://raw.githubusercontent.com/barbarossace/threejs-planets/main/assets/saturn_ring.png');
...
function onPlanetClick(event) {
    ...
    if (intersects.length > 0) {
        ...
        if(clickedObject.userData.type) {
            ...
            infoTimeout = setTimeout(() => { infoBox.classList.add('hidden'); }, 4000);
        }
...
function playMusicOnFirstInteraction() {
    ...
    if (playPromise !== undefined) {
        playPromise.catch(error => {
            console.error("A reprodução da música foi bloqueada:", error);
        });
    }
}
